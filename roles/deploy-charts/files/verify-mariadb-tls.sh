...
#
# Usage:
#   roles/deploy-charts/files/verify-mariadb-tls.sh [SERVICE] [NAMESPACE]
#
...
#
# Examples:
#   roles/deploy-charts/files/verify-mariadb-tls.sh keystone
#   roles/deploy-charts/files/verify-mariadb-tls.sh glance
...
#     CLIENT_SECRET=nova-client roles/deploy-charts/files/verify-mariadb-tls.sh nova
