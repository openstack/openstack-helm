...
# Directory holding the heat-*.yaml templates this test renders. Set by
# roles/deploy-charts/tasks/manila_test.yaml, which stages them next to this
# script; they are shared with nova_test.sh, hence the separate directory.
