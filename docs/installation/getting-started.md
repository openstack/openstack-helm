...
As you can see by this example, `10.25.162.193` is the `kube-dns-2924299975-xxtrg` endpoint. Now, have a look at the current `kube-controller-manager-kubenode01` `/etc/resolv.conf`:
```
